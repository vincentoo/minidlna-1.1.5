...
extern int xasprintf(char **strp, char *fmt, ...);
extern int _lang2cp(char *lang);
extern  void vc_scan(struct song_metadata *psong, const char *comment, const size_t length);
